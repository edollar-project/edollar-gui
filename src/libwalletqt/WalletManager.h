...
public:
    enum LogLevel {
        LogLevel_Silent = Edollar::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Edollar::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Edollar::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Edollar::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Edollar::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Edollar::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Edollar::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Edollar::WalletManagerFactory::LogLevel_Max,
    };
