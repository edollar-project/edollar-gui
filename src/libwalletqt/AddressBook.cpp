...
AddressBook::AddressBook(Edollar::AddressBook *abImpl,QObject *parent)
...
QList<Edollar::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Edollar::AddressBookRow * AddressBook::getRow(int index) const
{
...
bool AddressBook::addRow(const QString &address, const QString &payment_id, const QString &description) const
{
    ...
    bool r = m_addressBookImpl->addRow(address.toStdString(), description.toStdString());
