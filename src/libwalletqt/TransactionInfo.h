...
public:
    enum Direction {
        Direction_In  =  Edollar::TransactionInfo::Direction_In,
        Direction_Out =  Edollar::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Edollar::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Edollar::TransactionInfo * m_pimpl;
